...
use selendra_runtime_indracores::origin;
use sp_core::H256;
...
use xcm_builder::{
	...
	AllowTopLevelPaidExecutionFrom, Case, ChildIndracoreAsNative, ChildIndracoreConvertsVia,
	ChildSystemIndracoreAsSuperuser, CurrencyAdapter as XcmCurrencyAdapter, FixedRateOfFungible,
...
pub type SovereignAccountOf =
	(ChildIndracoreConvertsVia<IndraId, AccountId>, AccountId32Aliases<AnyNetwork, AccountId>);
