...
// `SESSION_DELAY` is used to delay any changes to indras registration or configurations.
...
pub mod pallet {
	...
	/// The indracore attestation keys of the validators actively participating in indracore consensus.
