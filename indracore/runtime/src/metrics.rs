...
//! Runtime declaration of the indracore metrics.
...
pub struct Metrics {
	...
	/// Counts how many indracore candidates processed in `enter_inner`.
...
pub const METRICS: Metrics = Metrics {
	inherent_data_weight: CounterVec::new(INDRACORE_INHERENT_DATA_WEIGHT),
	bitfields_processed: Counter::new(INDRACORE_INHERENT_DATA_BITFIELDS_PROCESSED),
	candidates_processed: CounterVec::new(INDRACORE_INHERENT_DATA_CANDIDATES_PROCESSED),
	dispute_sets_processed: CounterVec::new(INDRACORE_INHERENT_DATA_DISPUTE_SETS_PROCESSED),
	disputes_included: Counter::new(INDRACORE_INHERENT_DATA_DISPUTE_SETS_INCLUDED),
