...
//! WASM validation for adder indracore.

use crate::{BlockData, HeadData};
use core::panic;
use indracore::primitives::{HeadData as GenericHeadData, ValidationResult};
use parity_scale_codec::{Decode, Encode};
use sp_std::vec::Vec;

#[no_mangle]
pub extern "C" fn validate_block(params: *const u8, len: usize) -> u64 {
	let params = unsafe { indracore::load_params(params, len) };
	let parent_head =
	...
	indracore::write_result(&ValidationResult {
