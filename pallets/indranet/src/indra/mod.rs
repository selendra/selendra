...
pub mod pallet {
	...
	bind_topic!(ClusterRegistryEvent, b"^indranet/registry/cluster");
	#[derive(Encode, Decode, Clone, Debug)]
	pub enum ClusterRegistryEvent {
		PubkeyAvailable { cluster: ContractClusterId, pubkey: ClusterPublicKey },
	}

	bind_topic!(ContractRegistryEvent, b"^indranet/registry/contract");
	#[derive(Encode, Decode, Clone, Debug)]
	...
	/// See also: `indratory::storage::pink_runtime_version`.
	#[pallet::storage]
