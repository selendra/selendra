...
pub mod pallet {
	...
	bind_topic!(RegistryEvent, b"^indranet/registry/event");
	...
	/// Mapping from worker pubkey to Indranet Network identity
	#[pallet::storage]
	...
	pub struct OldWorkerInfo<AccountId> {
		...
		/// The [confidence level](https://wiki.indranet.network/en-us/mine/solo/1-2-confidential-level-evaluation/#confidence-level-of-a-miner)
		/// of the worker
