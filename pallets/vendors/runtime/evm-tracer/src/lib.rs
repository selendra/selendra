...
pub mod tracer {
    ...
    impl EvmTracer {
        pub fn new() -> Self {
            Self {
                step_event_filter: selendra_primitives_ext::selendra_ext::step_event_filter(),
            }
        }
        ...
        pub fn emit_new() {
            selendra_primitives_ext::selendra_ext::call_list_new();
        }
    }
    ...
    impl EvmListener for EvmTracer {
        ...
        fn event(&mut self, event: evm::tracing::Event) {
            ...
            selendra_primitives_ext::selendra_ext::evm_event(message);
        }
    }
    ...
    impl GasometerListener for EvmTracer {
        ...
        fn event(&mut self, event: evm_gasometer::tracing::Event) {
            ...
            let message = event.encode();
            selendra_primitives_ext::selendra_ext::gasometer_event(message);
        }
    }
    ...
    impl RuntimeListener for EvmTracer {
        ...
        fn event(&mut self, event: evm_runtime::tracing::Event) {
            ...
            let message = event.encode();
            selendra_primitives_ext::selendra_ext::runtime_event(message);
        }
    }
}
