...
use selendra_client_evm_tracing::{
    formatters::ResponseFormatter,
    types::block::{self, TransactionTrace},
};
pub use selendra_rpc_core_trace::{FilterRequest, TraceServer};
use selendra_rpc_core_types::{RequestBlockId, RequestBlockTag};
use selendra_rpc_primitives_debug::DebugRuntimeApi;
    ...
    C::Api: ApiExt<B>,
{
    ...
    fn cache_block(
        ...
        let mut traces: Vec<_> =
            selendra_client_evm_tracing::formatters::TraceFilter::format(proxy)
