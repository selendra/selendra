...
use webcontract_types::messaging::MessageOrigin;
...
pub fn tag(sender: &MessageOrigin, seq: u64) -> Vec<u8> {
	("WebContractMqOffchainMessages", sender, seq).encode()
}
...
mod tests {
	...
	use webcontract_types::messaging::{Message, MessageOrigin, SignedMessage, Topic};
	...
	fn sync_msg_call(i: u8, seq: u64) -> TestCall {
		TestCall::WebContractMq(Call::<Test>::sync_offchain_message {
