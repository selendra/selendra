...
pub mod pallet {
	...
	pub use web_contract_types::AttestationReport;
	// Re-export
	// TODO: Legacy
	...
	bind_topic!(RegistryEvent, b"^web-contract/registry/event");
	...
	bind_topic!(GatekeeperRegistryEvent, b"^web-contract/registry/gk_event");
	#[derive(Encode, Decode, TypeInfo, Clone, Debug)]
	...
	pub struct OldWorkerInfo<AccountId> {
		...
		/// The [confidence level](https://wiki.web-contract.network/en-us/mine/solo/1-2-confidential-level-evaluation/#confidence-level-of-a-miner)
		/// of the worker
