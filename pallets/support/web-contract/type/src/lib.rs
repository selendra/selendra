...
pub mod messaging {
	...
	pub use web_contract_mq::{bind_topic, types::*};
	...
	bind_topic!(SystemEvent, b"web_contract/system/event");
	#[derive(Encode, Decode, Debug, TypeInfo)]
	...
	bind_topic!(WorkingReportEvent, b"web_contract/mining/report");
	...
	bind_topic!(WorkingInfoUpdateEvent<BlockNumber>, b"^web_contract/mining/update");
	...
	bind_topic!(GatekeeperLaunch, b"web_contract/gatekeeper/launch");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
	...
	bind_topic!(GatekeeperChange, b"web_contract/gatekeeper/change");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
	...
	bind_topic!(KeyDistribution<BlockNumber>, b"web_contract/gatekeeper/key");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
...
pub use sp_core::sr25519::{
	Public as WorkerPublicKey, Public as ContractPublicKey, Public as ClusterPublicKey,
	Public as MasterPublicKey, Public as EcdhPublicKey, Signature as Sr25519Signature,
};
