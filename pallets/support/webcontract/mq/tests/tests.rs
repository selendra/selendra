use webcontract_mq::{MessageOrigin, traits::MessageChannel};
...
fn test_send_message() {
    ...
    use webcontract_mq::{MessageSendQueue, MessageSigner};
...
#[test]
fn test_dispatcher() {
    use webcontract_mq::{Message, MessageDispatcher};
