...
pub mod messaging {
    ...
    pub use webcontract_mq::bind_topic;
    pub use webcontract_mq::types::*;
    ...
    bind_topic!(SystemEvent, b"webcontract/system/event");
    #[derive(Encode, Decode, Debug, TypeInfo)]
    ...
    bind_topic!(WorkingReportEvent, b"webcontract/mining/report");
    ...
    bind_topic!(WorkingInfoUpdateEvent<BlockNumber>, b"^webcontract/mining/update");
    ...
    bind_topic!(GatekeeperLaunch, b"webcontract/gatekeeper/launch");
    #[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
    ...
    bind_topic!(GatekeeperChange, b"webcontract/gatekeeper/change");
    #[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
    ...
    bind_topic!(KeyDistribution<BlockNumber>, b"webcontract/gatekeeper/key");
    #[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
    ...
    // Messages: Gatekeeper
    bind_topic!(GatekeeperEvent, b"webcontract/gatekeeper/event");
    #[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
