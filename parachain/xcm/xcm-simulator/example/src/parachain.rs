...
use selendra_core_primitives::BlockNumber as RelayBlockNumber;
use selendra_parachain::primitives::{
...
parameter_types! {
	pub const TsnLocation: MultiLocation = MultiLocation::parent();
	pub const RelayNetwork: NetworkId = NetworkId::Testnet;
...
parameter_types! {
	...
	pub TsnPerSecondPerByte: (AssetId, u128, u128) = (Concrete(Parent.into()), 1, 1);
...
pub type LocalAssetTransactor = (
	XcmCurrencyAdapter<Balances, IsConcrete<TsnLocation>, LocationToAccountId, AccountId, ()>,
	NonFungiblesAdapter<
		ForeignUniques,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		SelendraXcm: pallet_xcm::{Pallet, Call, Event<T>, Origin},
