...
use selendra_primitives::v2::{CollatorId, CollatorPair, Hash};
use sp_core::Pair;
use std::{
	collections::HashMap,
	sync::{
...
mod tests {
	...
	use selendra_primitives::v2::{Hash, PersistedValidationData};
	...
	fn validate_collation(collator: &Collator, parent_head: HeadData, collation: Collation) {
		use selendra_node_core_pvf::testing::validate_candidate;
