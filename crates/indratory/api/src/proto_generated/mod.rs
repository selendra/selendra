...
pub use iruntime_rpc::*;
pub use protos_codec_extensions::*;

pub const PROTO_DEF: &str = include_str!("../../proto/iruntime_rpc.proto");
...
impl IndratoryInfo {
	pub fn debug_info(&self) -> Info {
		...
		Info {
			...
			cluster: self.system.as_ref().map(|s| s.number_of_clusters).unwrap_or_default(),
