...
use indranet_crypto::sr25519::Persistence;
use indranet_mq::{ContractClusterId, MessageOrigin};
use indranet_types::contract::messaging::ResourceType;
use pink::{
    capi::v1::{
...
pub use indranet_types::contract::InkCommand;
...
impl RuntimeHandleMut<'_> {
    ...
    pub fn instantiate(
        ...
        let buf = indranet_types::contract::contract_id_preimage(
