...
use indranet_types::{wrap_content_to_sign, SignedContentType};
use sp_core::sr25519;

use indranet_crypto::sr25519::{Signature, Signing, Sr25519SecretKey};
...
pub fn seal(
    ...
    // TODO.shelven: seal with identity key so the newly handovered iruntime do not need to do an extra sync to get master
    // key
