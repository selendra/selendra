...
pub mod messaging {
	...
	pub use indranet_mq::{bind_topic, types::*};
	...
	bind_topic!(SystemEvent, b"indranet/system/event");
	#[derive(Encode, Decode, Debug, TypeInfo)]
	...
	bind_topic!(WorkingReportEvent, b"indranet/mining/report");
	...
	bind_topic!(WorkingInfoUpdateEvent<BlockNumber>, b"^indranet/mining/update");
	...
	bind_topic!(GatekeeperLaunch, b"indranet/gatekeeper/launch");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
	...
	bind_topic!(GatekeeperChange, b"indranet/gatekeeper/change");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
	...
	bind_topic!(KeyDistribution<BlockNumber>, b"indranet/gatekeeper/key");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
	...
	// Messages: Gatekeeper
	bind_topic!(GatekeeperEvent, b"indranet/gatekeeper/event");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
