...
const PINK_EVENT_TOPIC: &[u8] = b"indranet.pink.event";
...
/// A indranet-mq message with optional encryption key
#[derive(Encode, Decode, Debug)]
#[cfg_attr(feature = "std", derive(scale_info::TypeInfo))]
...
/// Pink defined environment. Used this environment to access the indra contract runtime features.
