...
pub fn create_extrinsic(
	...
	function: impl Into<selendra_runtime::Call>,
	nonce: Option<u32>,
	...
	selendra_runtime::UncheckedExtrinsic::new_signed(
		...
		selendra_runtime::Signature::Sr25519(signature),
		extra,
	)
}
...
> {
	...
	let (rpc_extensions_builder, rpc_setup) = {
		...
		let rpc_extensions_builder = move |deny_unsafe, subscription_executor| {
			let deps = selendra_node_rpc::FullDeps {
				client: client.clone(),
				pool: pool.clone(),
				select_chain: select_chain.clone(),
				chain_spec: chain_spec.cloned_box(),
				deny_unsafe,
				babe: selendra_node_rpc::BabeDeps {
					babe_config: babe_config.clone(),
					shared_epoch_changes: shared_epoch_changes.clone(),
					keystore: keystore.clone(),
				},
				grandpa: selendra_node_rpc::GrandpaDeps {
			...
			selendra_node_rpc::create_full(deps, rpc_backend.clone()).map_err(Into::into)
		};
