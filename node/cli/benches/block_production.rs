...
fn new_node(tokio_handle: Handle) -> selendra_node_cli::service::NewFullBase {
	...
	let spec = Box::new(selendra_node_cli::chain_spec::development_config());
	...
	selendra_node_cli::service::new_full_base(config, false, |_, _| ())
...
fn extrinsic_set_time(now: u64) -> OpaqueExtrinsic {
	selendra_runtime::UncheckedExtrinsic {
		signature: None,
		function: selendra_runtime::Call::Timestamp(pallet_timestamp::Call::set { now }),
	}
	.into()
}
...
fn import_block(
	...
	built: BuiltBlock<
		...
		<FullClient as sp_api::CallApiAt<selendra_primitives::Block>>::StateBackend,
	>,
) {
