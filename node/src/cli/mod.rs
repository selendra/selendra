...
use commands::{BootstrapChainCmd, BootstrapNodeCmd, ConvertChainspecToRawCmd, PurgeChainCmd};
use sc_cli::{
...
impl SubstrateCli for Cli {
	...
	fn load_spec(&self, id: &str) -> Result<Box<dyn sc_service::ChainSpec>, String> {
		...
		let chainspec = match id {
			"mainnet" => crate::service::chain_spec::mainnet_config(),

			"testnet" => crate::service::chain_spec::testnet_config(),
			_ => crate::service::chain_spec::ChainSpec::from_json_file(id.into()),
		};
