...
pub fn mainnet_chainspec() -> &'static [u8] {
	include_bytes!("../../resources/mainnet_chainspec.json")
}

pub fn testnet_chainspec() -> &'static [u8] {
	include_bytes!("../../resources/testnet_chainspec.json")
}
...
pub fn mainnet_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(mainnet_chainspec())
}

pub fn testnet_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(testnet_chainspec())
}
