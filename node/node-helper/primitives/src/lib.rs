...
pub use selendra_parachain::primitives::{BlockData, HorizontalMessages, UpwardMessages};
...
///
/// - does not contain the erasure root; that's computed at the Selendra level, not at Forest
/// - contains a proof of validity.
#[derive(Clone, Encode, Decode)]
#[cfg(not(target_os = "unknown"))]
pub struct Collation<BlockNumber = selendra_primitives::BlockNumber> {
