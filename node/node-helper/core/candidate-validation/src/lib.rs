...
use selendra_node_subsystem_util::executor_params_at_relay_parent;
...
pub struct CandidateValidationSubsystem {
	...
	pub metrics: Metrics,
	#[allow(missing_docs)]
	pub pvf_metrics: selendra_node_core_pvf::Metrics,
	config: Config,
}
...
impl ValidationBackend for ValidationHost {
	...
	async fn validate_candidate(
		...
		let priority = selendra_node_core_pvf::Priority::Normal;
