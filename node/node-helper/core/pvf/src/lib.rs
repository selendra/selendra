...
//!
//! (b) PVF execution. This accepts the PVF [`params`][`selendra_parachain::primitives::ValidationParams`]
...
pub use selendra_node_core_pvf_common::{
...
pub use selendra_node_core_pvf_execute_worker::worker_entrypoint as execute_worker_entrypoint;
pub use selendra_node_core_pvf_prepare_worker::worker_entrypoint as prepare_worker_entrypoint;
