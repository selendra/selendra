...
use selendra_node_core_pvf_common::prepare::MemoryStats;
	...
	fn try_register(registry: &prometheus::Registry) -> Result<Self, prometheus::PrometheusError> {
		let inner = MetricsInner {
			...
			prepare_concluded: prometheus::register(
				prometheus::Counter::new(
					"selendra_pvf_prepare_concluded",
			...
			preparation_max_rss: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"selendra_pvf_preparation_max_rss",
			...
			preparation_max_resident: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"selendra_pvf_preparation_max_resident",
			...
			preparation_max_allocated: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"selendra_pvf_preparation_max_allocated",
