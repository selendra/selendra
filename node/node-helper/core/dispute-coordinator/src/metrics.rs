	...
	fn try_register(registry: &prometheus::Registry) -> Result<Self, prometheus::PrometheusError> {
		let metrics = MetricsInner {
			...
			prometheus::Counter::with_opts(
				prometheus::Opts::new(
					"selendra_parachain_dispute_refrained_participations",
			...
			participation_durations: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"selendra_parachain_dispute_participation_durations",
			...
			participation_pipeline_durations: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"selendra_parachain_dispute_participation_pipeline_durations",
			...
			participation_priority_queue_size: prometheus::register(
				prometheus::Gauge::new("selendra_parachain_dispute_participation_priority_queue_size", 
			...
			participation_best_effort_queue_size: prometheus::register(
				prometheus::Gauge::new("selendra_parachain_dispute_participation_best_effort_queue_size", 
