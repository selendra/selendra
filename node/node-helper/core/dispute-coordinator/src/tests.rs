...
use selendra_node_primitives::{SignedDisputeStatement, SignedFullStatement, Statement};
	...
	test_harness(|mut test_state, mut virtual_overseer| {
		Box::pin(async move {
			...
			let supermajority_threshold =
				selendra_primitives::v2::supermajority_threshold(test_state.validators.len());
