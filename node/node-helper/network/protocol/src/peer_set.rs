...
const LEGACY_VALIDATION_PROTOCOL_V1: &str = "/selendra/validation/1";
const LEGACY_COLLATION_PROTOCOL_V1: &str = "/selendra/collation/1";
...
mod tests {
	...
	fn all_protocol_names_are_known() {
		...
		let validation_legacy = "/selendra/validation/1";
		assert_eq!(
		...
		let collation_legacy = "/selendra/collation/1";
		assert_eq!(
