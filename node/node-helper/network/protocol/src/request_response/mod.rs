...
impl Protocol {
	...
	const fn get_legacy_name(self) -> &'static str {
		match self {
			Protocol::ChunkFetchingV1 => "/selendra/req_chunk/1",
			Protocol::CollationFetchingV1 => "/selendra/req_collation/1",
			Protocol::PoVFetchingV1 => "/selendra/req_pov/1",
			Protocol::AvailableDataFetchingV1 => "/selendra/req_available_data/1",
			Protocol::StatementFetchingV1 => "/selendra/req_statement/1",
			Protocol::DisputeSendingV1 => "/selendra/send_dispute/1",
		}
	}
}
