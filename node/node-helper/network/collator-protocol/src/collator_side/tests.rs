...
use selendra_node_subsystem_util::{reputation::add_reputation, TimeoutExt};
...
use selendra_primitives_test_helpers::TestCandidateBuilder;
...
fn test_harness<T: Future<Output = TestHarness>>(
	...
	let _ = env_logger::builder()
		.is_test(true)
		.filter(Some("selendra_collator_protocol"), log::LevelFilter::Trace)
