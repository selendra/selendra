...
use selendra_node_test::bench::{BenchDb, BlockType, DatabaseType, KeyTypes, Profile};
...
impl sc_transaction_pool_api::TransactionPool for Transactions {
	...
	) -> PoolFuture<Vec<Result<selendra_primitives::Hash, Self::Error>>, Self::Error> {
		unimplemented!()
	}
