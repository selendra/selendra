...
//! Forests timestamp related primitives.
//!
...
use forests_primitives_core::relay_chain::v2::Slot;
...
mod tests {
	...
	use forests_primitives_core::{relay_chain::Hash as PHash, PersistedValidationData};
	...
	fn call_validate_block(
		...
		forests_test_client::validate_block(
			ValidationParams {
