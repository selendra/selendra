...
impl RuntimeApiSubsystemClient for BlockChainRpcClient {
	...
	async fn persisted_validation_data(
		&self,
		at: Hash,
		para_id: forests_primitives_core::ParaId,
		assumption: selendra_primitives::v2::OccupiedCoreAssumption,
	) -> Result<
		Option<
			forests_primitives_core::PersistedValidationData<
				Hash,
	...
	async fn dmq_contents(
		&self,
		at: Hash,
		recipient: forests_primitives_core::ParaId,
	) -> Result<
		Vec<forests_primitives_core::InboundDownwardMessage<selendra_core_primitives::BlockNumber>>,
		sp_api::ApiError,
	> {
	...
	async fn inbound_hrmp_channels_contents(
		...
		std::collections::BTreeMap<
			forests_primitives_core::ParaId,
			Vec<
