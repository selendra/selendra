...
//! forests-pallet-parachain-system is a base pallet for forests-based parachains.
//!
...
use forests_primitives_parachain_inherent::{MessageQueueChain, ParachainInherentData};
use frame_support::{
...
/// # fn main() {}
/// ```
pub use forests_pallet_parachain_system_proc_macro::register_validate_block;
...
pub mod pallet {
	...
	impl<T: Config> ProvideInherent for Pallet<T> {
		...
		const INHERENT_IDENTIFIER: InherentIdentifier =
			forests_primitives_parachain_inherent::INHERENT_IDENTIFIER;
...
impl<T: Config> Pallet<T> {
	...
	fn process_inbound_horizontal_messages(
		ingress_channels: &[(ParaId, forests_primitives_core::AbridgedHrmpChannel)],
	...
	/// [`CollectCollationInfo`](forests_primitives_core::CollectCollationInfo) runtime api.
