...
use primitives::{
    ...
    AccountId, SelendraNodeSessionKeys, Version as FinalityVersion, ADDRESSES_ENCODING,
    TOKEN_DECIMALS,
};
use serde_json::{Number, Value};
use sp_runtime::Perbill;

use crate::chain_spec::{cli::ChainSpecParams, keystore::AccountSessionKeys, SelendraNodeChainSpec};
...
/// Generate chain spec for new SelendraNode chains
...
fn calculate_initial_endowment(accounts: &[AccountId]) -> u128 {
    let total_issuance = 227_887_547u128 * 10u128.pow(TOKEN_DECIMALS);
