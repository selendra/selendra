...
impl pallet_mq::QueueNotifyConfig for MessageRouteConfig {
    ...
    fn on_message_received(message: &Message) -> DispatchResult {
        ...
        route_handlers! {
            ...
            IndranetPhatContracts::on_worker_cluster_message_received,
            IndranetPhatContracts::on_cluster_message_received,
            IndranetPhatContracts::on_contract_message_received,
