...
impl<T: frame_system::Config> module_funan::WeightInfo for WeightInfo<T> {
	...
	fn unauthorize_all(c: u32, ) -> Weight {
		(34_867_000 as Weight)
			...
			.saturating_add((19_560_000 as Weight).saturating_mul(c as Weight))
