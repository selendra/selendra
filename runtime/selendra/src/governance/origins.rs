...
pub mod pallet_custom_origins {
	...
	decl_ensure! {
		pub type Spender: EnsureOrigin<Success = Balance> {
			...
			BigTipper = 1000 * DOLLARS,
			SmallSpender = 1_0000 * DOLLARS,
			MediumSpender = 100_000 * DOLLARS,
			BigSpender = 1_000_000 * DOLLARS,
			Treasurer = 10_000_000 * DOLLARS,
		}
	}
}