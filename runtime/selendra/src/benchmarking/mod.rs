...
pub mod treasury {
	include!("../../../mandala/src/benchmarking/treasury.rs");
}
...
pub mod funan {
	include!("../../../mandala/src/benchmarking/funan.rs");
}
...
pub fn get_vesting_account() -> super::AccountId {
	super::SelendraFoundationAccounts::get()[0].clone()
}

pub fn get_benchmarking_collateral_currency_ids() -> Vec<CurrencyId> {
	vec![SEL, DOT, LCDOT, LDOT]
}
