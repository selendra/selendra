...
mod tests {
	...
	use crate::precompile::mock::{
		sel_evm_address, alice, susd_evm_address, bob, erc20_address_not_exists, lp_sel_susd_evm_address, new_test_ext,
		Balances, Test,
	};
	...
	fn name_works() {
		new_test_ext().execute_with(|| {
			...
			// DexShare
			context.caller = lp_sel_susd_evm_address();
	...
	fn total_supply_works() {
		new_test_ext().execute_with(|| {
			...
			// Token
			context.caller = susd_evm_address();
