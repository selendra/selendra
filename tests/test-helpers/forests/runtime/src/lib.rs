...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("forests-test-parachain"),
	impl_name: create_runtime_str!("forests-test-parachain"),
	authoring_version: 1,
	// Read the note above.
	spec_version: 1,
	impl_version: 1,
...
const MAXIMUM_BLOCK_WEIGHT: Weight = WEIGHT_PER_SECOND
	.saturating_div(2)
	.set_proof_size(forests_primitives_core::relay_chain::v2::MAX_POV_SIZE as u64);
...
impl forests_pallet_parachain_system::Config for Runtime {
	...
	type CheckAssociatedRelayNumber = forests_pallet_parachain_system::AnyRelayNumber;
}

parameter_types! {
	pub storage ParachainId: forests_primitives_core::ParaId = 100.into();
}
