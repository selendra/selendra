...
pub struct ExportGenesisStateCommand {
	...
	#[clap(flatten)]
	pub base: forests_client_cli::ExportGenesisStateCommand,
}
...
pub struct ExportGenesisWasmCommand {
	...
	#[clap(flatten)]
	pub base: forests_client_cli::ExportGenesisWasmCommand,
}
...
impl SubstrateCli for TestCollatorCli {
	fn impl_name() -> String {
		"Forests zombienet test parachain".into()
	}
	...
	fn description() -> String {
		format!(
			"Forests zombienet test parachain\n\nThe command-line arguments provided first will be \
	...
	fn native_runtime_version(_: &Box<dyn ChainSpec>) -> &'static RuntimeVersion {
		&forests_test_service::runtime::VERSION
	}
}
