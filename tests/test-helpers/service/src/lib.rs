...
pub type Client = FullClient<test_runtime::RuntimeApi, SelendraTestExecutorDispatch>;
...
pub fn new_full(
	...
	selendra_service::new_full::<test_runtime::RuntimeApi, SelendraTestExecutorDispatch, _>(
		config,
		is_collator,
		None,
		true,
...
impl SelendraTestNode {
	...
	pub async fn send_extrinsic(
		&self,
		function: impl Into<test_runtime::Call>,
...
pub fn construct_transfer_extrinsic(
	...
	let function = test_runtime::Call::Balances(pallet_balances::Call::transfer {
