...
Generate bytecode for predeployment of ERC20 smart contracts in Selendra.
...
## ERC20 Contracts
These ERC20 contracts make native and cross-chain tokens available inside Selendra EVM.
- Mirrored Token contract address: `ADDRESS.SEL`, `ADDRESS.SUSD`...(`./contracts/utils/Address.sol`)
```
...
These contracts make other chain-native functionalities available in Selendra EVM.
...
These contracts will make Selendra's DeFi primitives (stablecoin, staking derivative, and DeX) available in Selendra EVM.
