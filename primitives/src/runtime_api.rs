...
//! * stable - used on stable production networks like Selendra and Selendra. There is only one
//!   stable API at a single point in time.
//! * staging - used on test networks depending on the development needs
...
use selendra_parachain::primitives as ppp;
use sp_staking;
