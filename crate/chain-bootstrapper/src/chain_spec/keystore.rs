...
use selendra_primitives::{AccountId, AuraId, AuthorityId};
...
fn create_aleph_key(keystore: &impl Keystore) -> AuthorityId {
	Keystore::ed25519_public_keys(keystore, selendra_primitives::KEY_TYPE)
		.pop()
		.unwrap_or_else(|| {
			Keystore::ed25519_generate_new(keystore, selendra_primitives::KEY_TYPE, None)
...
pub fn create_account_session_keys(
	...
	AccountSessionKeys { account_id, aura_key, aleph_key }
}
