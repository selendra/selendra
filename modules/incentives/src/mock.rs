...
pub const BTC_SUSD_LP: CurrencyId =
	CurrencyId::DexShare(DexShare::Token(TokenSymbol::RENBTC), DexShare::Token(TokenSymbol::SUSD));
pub const DOT_SUSD_LP: CurrencyId =
	CurrencyId::DexShare(DexShare::Token(TokenSymbol::DOT), DexShare::Token(TokenSymbol::SUSD));
...
parameter_type_with_key! {
	pub ExistentialDeposits: |currency_id: CurrencyId| -> Balance {
		...
		match currency_id {
			CurrencyId::Token(TokenSymbol::SUSD) => 10,
			_ => Default::default()
		}
	};
}
