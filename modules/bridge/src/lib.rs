...
//! # Pallet for bridging Substrate and Evm chains.
//!
//! This pallet implement a general-purpose bridge to pass arbitrary messages
//! Selendra Substrate Chain and Ethereum or any other target network.
//!
//! ## Overview
...
pub mod pallet {
	...
	pub type ChainNonces<T> = StorageMap<_, Blake2_256, ChainId, DepositNonce>;
